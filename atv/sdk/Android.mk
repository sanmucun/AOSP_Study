...
source_properties_file := \
    $(HOST_OUT)/device/unisoc/atv/sdk/images_$(TARGET_CPU_ABI)_source.properties

ALL_SDK_FILES += $(source_properties_file)

$(source_properties_file): $(TOPDIR)device/unisoc/atv/sdk/images_$(TARGET_CPU_ABI)_source.prop_template
	@echo Generate $@
	$(hide) mkdir -p $(dir $@)
